$(document).ready(function () {
  ...
  var slideObj = "";
  slideObj +=
    '<div class="single-welcome-slide bg-img bg-overlay" style="background-image: url(img/bg-img/slider0.jpg);" data-img-url="img/bg-img/slider0.jpg">' +
  ...
  //-------------
  slideObj +=
    '<div class="single-welcome-slide bg-img bg-overlay" style="background-image: url(img/bg-img/slider1.jpg);" data-img-url="img/bg-img/slider2.jpg">' +
    '<div class="welcome-content h-100">' +
    '<div class="container h-100">' +
    '<div class="row h-100 align-items-center">' +
    '  <div class="col-12">' +
